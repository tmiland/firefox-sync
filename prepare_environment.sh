...
# listening port
DEFAULT_CONTAINER_EXPORT_PORT=8000
...
DEFAULT_SYNCSTORAGE_IMAGE_TAG=0.18.3-20250526T064429
read -e -rp "Syncstorage image tag [latest/<tag>] [${DEFAULT_SYNCSTORAGE_IMAGE_TAG}]: " SYNCSTORAGE_IMAGE_TAG
